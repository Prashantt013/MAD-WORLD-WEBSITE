...
export const CATEGORY_META = {
  games:  { label: 'Games',         color: '#a6182c', path: '/games' },
  anime:  { label: 'Anime',         color: '#7b3fb0', path: '/anime' },
  shows:  { label: 'Shows',         color: '#1f5fa8', path: '/shows' },
  horror: { label: 'Horror',        color: '#5c0a12', path: '/horror' },
};
